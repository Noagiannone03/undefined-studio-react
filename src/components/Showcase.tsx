...
export default function Showcase() {
    ...
    const projects = [
        { title: 'ALPHA MOBILE', category: 'Product / iOS', color: 'bg-peach' },
    ...
    return (
        <section className="relative min-h-screen w-full bg-cream border-y-4 border-black py-32 overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-6">
                <div className="flex flex-col md:flex-row items-center justify-between mb-20">
                    <h2 className="font-display text-7xl font-black uppercase tracking-tighter">
                        Latest<br /><span className="text-white drop-shadow-[4px_4px_0px_#000]">Impacts</span>
                    </h2>
                    <div className="sticker bg-white transform rotate-3 mt-8 md:mt-0 max-w-xs">
                        <p className="text-sm font-bold">Refusing the standard, one pixel at a time. Crafted with care.</p>
                    </div>
                </div>
                        ...
                        >
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    ...
                                    <h3 className="font-display text-4xl md:text-6xl font-black uppercase">
                                        {project.title}
                                    </h3>
                                </div>
                            ...
                            {/* Decorative Squiggle inside card */}
            ...
            <div className="star top-[10%] right-[10%] scale-150 animate-spin-slow opacity-20" />
            <div className="star bottom-[5%] left-[5%] scale-[2] animate-bounce-soft opacity-10" />
        </section>
    )
}
